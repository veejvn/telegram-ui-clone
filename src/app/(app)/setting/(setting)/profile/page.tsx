...
export default function TelegramProfile() {
  ...
  return (
    <div className="min-h-screen bg-black text-white flex justify-center items-center p-4">
      <Card className="w-[360px] bg-zinc-900 rounded-2xl shadow-xl p-4">
        ...
        <CardContent className="space-y-4">
          <Input
            className="bg-zinc-800 border-none text-white placeholder-zinc-500"
            value={firstName}
          ...
          <div className="mt-6 space-y-2">
            <button className="w-full bg-zinc-800 rounded-lg p-3 text-blue-400 text-sm text-center">
              Add Another Account
            </button>
            ...
            <button className="w-full bg-zinc-800 rounded-lg p-3 text-red-500 text-sm text-center mt-2">
              Log Out
            </button>
          </div>
