...
import { ChevronRight,  Image as ImageIcon, Play, Plus, ChevronLeft } from "lucide-react";
...
export default function AutoDownloadSettings() {
  ...
  return (
    ...
    <h1 className="text-center text-2xl mb-2">Channels</h1>
        ...
        <div className="bg-neutral-900 rounded-xl divide-y divide-neutral-800">
          <div className="flex justify-between items-center p-4">
            <div className="flex items-center space-x-3">
              <ImageIcon className="text-cyan-400" aria-hidden="true" />
