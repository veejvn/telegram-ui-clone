...
export default function FolderPage() {
  ...
  return (
    <div className="p-4">
      ...
      {/* Folder List */}
      <div className="space-y-2 divide-y border rounded-2xl mb-6 p-2">
        <div className="p-3">
      ...
      <div className="rounded-xl p-4 flex justify-between items-center">
        ...
        <label className="relative inline-flex items-center cursor-pointer">
          ...
          />
          <div className="w-11 h-6 bg-gray-400 rounded-full peer peer-checked:bg-green-500 after:content-[''] after:absolute after:left-[4px] after:top-[3px] after:bg-white after:border-gray-300 after:rounded-full after:h-4 after:w-4 after:transition-all peer-checked:after:translate-x-full"></div>
        </label>
      </div>
      <p className="text-gray-500 text-sm mt-2">
