                    ...
                    <Popover>
                        ...
                        <PopoverContent className="w-44 bg-[#1a1a1a] text-white p-0 rounded-2xl ml-3">
                            <div className="flex flex-col">
                                <Button
                                    className={`flex items-center justify-between px-4 py-2 bg-[#1a1a1a] hover:bg-[#232323] transition text-left rounded-t-2xl ${sortBy === "lastSeen" ? "font-semibold text-white" : ""
                                        }`}
                                ...
                                <Button
                                    className={`flex items-center justify-between px-4 py-2 bg-[#1a1a1a] hover:bg-[#232323] transition text-left rounded-b-2xl ${sortBy === "name" ? "font-semibold text-white" : ""
                                        }`}
