...
export default function AutoDownloadSettings() {
  ...
  return (
    ...
    <h1 className="text-center font-semibold text-2xl mb-4">Group Chat</h1>
      ...
      <div>
        ...
        <p className="text-xs text-zinc-500 dark:text-zinc-400 mt-2">
          Automatically save all new media from group chats to your Photos app.
        </p>
      </div>
...
// This code defines a React component for managing auto-download settings in group chats.