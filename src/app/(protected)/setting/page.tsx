...
const group1: SettingItem[] = [
  {
    ...
    icon: (
      <span className="inline-flex items-center justify-center h-7 w-7 rounded-[10px] bg-[#1877F2] mr-2">
  ...
  },
  {
    title: "Recent Calls",
    icon: (
      <span className="inline-flex items-center justify-center h-7 w-7 rounded-[10px] bg-[#34C759] mr-2">
...
const group2: SettingItem[] = [
  {
    ...
    icon: (
      <span className="inline-flex items-center justify-center h-7 w-7 rounded-[10px] bg-[#FF3B30] mr-2">
  ...
  },
  {
    ...
    icon: (
      <span className="inline-flex items-center justify-center h-7 w-7 rounded-[10px] bg-[#8E8E93] mr-2">
  ...
  const sections = [
    ...
    },
    {
      ...
      render: () => (
        ...
        >
          <span className="inline-flex items-center justify-center h-7 w-7 rounded-[10px] bg-[#FF2D55] mr-2">
            {user?.avatarUrl ? (
              <img
                src={user.avatarUrl}
                alt="avatar"
          ...
          <div className="flex-1 min-w-0">
            <div className="text-[15px] font-normal">My Profile</div>
          </div>
