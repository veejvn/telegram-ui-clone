...
export const viewport: Viewport = {
  ...
  interactiveWidget: "resizes-visual", // Changed from "resizes-content" to prevent auto-resize
};
...
export default function RootLayout({
  ...
  return (
    <html lang="en" suppressHydrationWarning>
      <head></head>
      <body className={`${inter.className} antialiased h-screen bg-gradient-to-b from-cyan-700/30 via-cyan-300/15 to-yellow-600/25`}>
        {/* <NoZoom /> */}
        <Providers>
